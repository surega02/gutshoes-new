...
export const storefrontRoutes = [
  ...
  {page: "checkout", path: "/checkout", render: (c) => <Checkout cart={c.cart} navigate={c.navigate} createOrder={c.createOrder} user={c.user} addresses={c.addresses} onCheckoutCreated={c.onCheckoutCreated} cartSource={c.cartSource} ensureServerCart={c.ensureServerCart} />},
